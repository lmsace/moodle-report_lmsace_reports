...
class siteresourceofcourseswidget extends widgets_info {
    ...
    public function get_report_table() {
        ...
        $morethencourse =
            new \report_lmsace_reports\local\table\siteresourceofmorecourse_table('reports-siteresourceofcourse-morecourse');
        $notenroll =
            new \report_lmsace_reports\local\table\siteresourceofnotenroll_table('reports-siteresourceofcourse-notenroll');
        $notvisits =
            new \report_lmsace_reports\local\table\siteresourceofnotvisit_table('reports-siteresourceofcourse-notvisit');

        $morethencoursefilterset =
            new \report_lmsace_reports\local\table\siteresourceofmorecourse_table_filterset('
                reports-siteresourceofcourse-morecourse-filter');
        $morethencourse->set_filterset($morethencoursefilterset);

        $notenrollfilterset =
            new \report_lmsace_reports\local\table\siteresourceofnotenroll_table_filterset('
                reports-siteresourceofcourse-notenroll-filter');
        $notenroll->set_filterset($notenrollfilterset);

        $notvisitsfilterset =
            new \report_lmsace_reports\local\table\siteresourceofnotvisit_table_filterset('
                reports-siteresourceofcourse-notvisit-filter');
